...
class DeepSeekAssistant {
    ...
    createAISidebar() {
        ...
        // 默认隐藏侧边栏，只有按 Ctrl+Shift+Q (Mac: ⌘+Shift+Q) 时才显示
...
您的问题："${userMessage}"已记录，服务恢复后会自动处理。`;
    ...
    toggleSidebar() {
        ...
        if (isHidden) {
            ...
            // 显示成功提示
            this.showTemporaryMessage('✅ AI助手已显示 (⌘+Shift+Q 切换)');
            console.log('✅ 显示操作完成');
            ...
            // 显示成功提示
            this.showTemporaryMessage('✅ AI助手已隐藏 (⌘+Shift+Q 切换)');
            console.log('✅ 隐藏操作完成');
        }
...
// 全局快捷键监听器（独立于类初始化）
/** Ctrl/⌘ + Shift + Q 全局快捷键：切换 AI 侧栏显示/隐藏  **************************/
...
if (!window.__DS_CTRL_Q_BOUND__) {
    ...
    console.log('✅ 已设置 Ctrl/⌘ + Shift + Q 切换侧栏（单监听，防抖，防重复）');
  }
