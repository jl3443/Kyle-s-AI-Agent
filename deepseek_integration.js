...
class DeepSeekAssistant {
    ...
    async callDeepSeekAPI(userMessage, tableData, model = 'deepseek-chat') {
        ...
        const messages = [
            {
                role: "system",
                content: "你是Kyle's AI Agent，一个智能助手。\n\n" +
                    "**主要功能**：\n" +
                    "1. 智能对话：回答用户的问题，提供有帮助的建议\n" +
                    "2. 金融AI产品分析：当用户明确询问或分析金融AI产品时，输出TSV格式数据\n\n" +
                    "**TSV输出格式**（仅在分析金融产品时使用）：\n" +
                    ...
                    "**注意**：\n" +
                    "- 对于一般问候或简单问题，请用自然语言友好回复\n" +
                    "- 只有在分析具体金融AI产品时才输出TSV格式\n" +
                    "- 参考价值：1-5星；应用赛道：银行|保险|信贷|支付|资产管理|财富管理|内部运营|Web3\n" +
                    "- 发展阶段：种子轮|A轮|B轮|C轮|D轮及更多|上市|成熟期；业务模式：To B|To C|SaaS|平台型"
            },
            ...this.conversationHistory,
            {
              role: "user",
